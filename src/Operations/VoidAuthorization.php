...
abstract class VoidAuthorization extends NotTokenizableOperation
{
     ...
     */
    public static function void($reference, Config $config = null)
    {
    ...
    public function process(array $data)
    {
        ...
        $requestData = [
            ...
            'order_description' => $model->description()
        ];
